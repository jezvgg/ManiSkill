...
import trimesh
from robots.fetch.stepping import pose_error
...
from robots.fetch.root_frame import (
    fold_root,
    is_planar_root,
    planar_base,
    unfold_root,
...
#: of names: `robots.fetch.extand.CONTINUOUS_JOINT_NAMES` is exactly such a list, and it silently
...
class SapienPlannerV2(SapienPlanner):
    ...
    `follow_*` in robots/fetch/extand.py executes exactly what it did before. `set_base_pose` is a
        ...
        *,
        ...
        while True:
            ...
            if (stalled or collide or not within_joint_limit) and not accepted_slack:
                ...
                # `level_in_place` in planners/oracle/oracle_common.py for the full reading.
                return {
